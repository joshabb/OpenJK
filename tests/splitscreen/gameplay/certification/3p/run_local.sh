...
here="$root/tests/splitscreen/gameplay/certification/3p"
...
OPENJK_CERT_RUN_ID="$run_id" GP502_DEFER_VALIDATE=1 "$here/run.sh"
OPENJK_CERT_RUN_ID="$run_id" "$here/run_lifecycle.sh"
