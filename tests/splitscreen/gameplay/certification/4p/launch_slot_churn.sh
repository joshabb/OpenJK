...
CFG="$HOME_PATH/base/splitqa/slot_churn.cfg"
...
"$BIN" \
	...
	+exec splitqa/slot_churn.cfg
status=$?
set -e

find "$HOME_PATH/base/screenshots" -type f -name 'gp5_4p_varied_slot_churn.png' \
